...
### مؤكَّد عملياً — 2026-07-31

**(أ) الإلغاء.** ألغى المالك الطلب `26073180840` من لوحة ZNET فردّ
`pin_kontrol` بـ `OK|3| - |` **بلا نصّ**، **وأعاد ZNET المبلغ**
(581.60 → 625.00). لذلك صار إلغاء المزوّد عندنا يسترجع مبلغ الوكيل تلقائياً
بدل تركه «عالقاً».

**(ب) القبول.** قبِل المالك الطلب `26073132942` وكتب ملاحظة، فجاء الردّ:
```
OK|2||هذا المنتج تم شحنه عالميا
```
- **الـ `Açıklama` يصل فعلاً** حين يكتبه المشغّل — الفراغ في حالة الإلغاء كان
  لأنه لم يُكتب نصّ، لا لأن ZNET لا يرسله.
- **خانة الـ PIN فارغة** لأن الباقة تُشحن مباشرةً على معرّف اللاعب فلا كود لها.
  ⇒ النجاح بلا PIN حالة **صحيحة** لا ناقصة؛ نعرض «شُحن مباشرةً ✓» مع ملاحظة
  المزوّد بدل خانة كود فارغة.
- الحالة `1` تأتي بشرطة في خانة الـ PIN: `OK|1| - |`.
