...
# أسعار صرف ابتدائية حسب عملة دفتر المتجر — كم وحدةً من كل عملة تساوي وحدةً
# من عملة الدفتر. تُزرع مرّة واحدة فقط، ثم يضبطها المالك من «أسعار الصرف».
RATES_BY_BASE = {
    "USD": {"TRY": "41.5000", "SYP": "12987.0000", "EUR": "0.9200"},
    "TRY": {"USD": "0.0241", "SYP": "312.9000", "EUR": "0.0222"},
}
